...
CASSERT(!ARCH_SUPPORTS_LARGE_PAGE_ADDRESSING, assert_lpae_is_not_supported);
...
#define SECTION_NORMAL_CACHED		\
				SECTION_TEXCB(MMU32B_ATTR_IWBWA_OWBWA_INDEX)
...
#define SMALL_PAGE_DEVICE		\
				SMALL_PAGE_TEXCB(MMU32B_ATTR_DEVICE_INDEX)
#define SMALL_PAGE_NORMAL		\
				SMALL_PAGE_TEXCB(MMU32B_ATTR_DEVICE_INDEX)
#define SMALL_PAGE_NORMAL_CACHED	\
				SMALL_PAGE_TEXCB(MMU32B_ATTR_IWBWA_OWBWA_INDEX)
...
#define MMU32B_ATTR_DEVICE_PRRR		\
			MMU32B_PRRR_IDX(MMU32B_ATTR_DEVICE_INDEX, 1, 0)
#define MMU32B_ATTR_DEVICE_NMRR		\
			MMU32B_NMRR_IDX(MMU32B_ATTR_DEVICE_INDEX, 0, 0)

#define MMU32B_ATTR_IWBWA_OWBWA_PRRR	\
			MMU32B_PRRR_IDX(MMU32B_ATTR_IWBWA_OWBWA_INDEX, 2, 1)
#define MMU32B_ATTR_IWBWA_OWBWA_NMRR	\
...
CASSERT(PLAT_XLAT_SIZE >= (MMU32B_L2_TABLE_SIZE * MAX_XLAT_TABLES),
	invalid_xlat_size);
...
void enable_mmu_secure(unsigned int flags)
{
	...
	sctlr = read_sctlr();
	sctlr |= SCTLR_M_BIT;
#if ARCH_SUPPORTS_VIRTUALIZATION
	sctlr |= SCTLR_WXN_BIT;
#endif
