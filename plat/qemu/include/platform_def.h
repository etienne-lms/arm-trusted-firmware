...
/* Load pageable part 2MB above secure DRAM base */
#define QEMU_OPTEE_PAGEABLE_LOAD_BASE	(SEC_DRAM_BASE + 0x00200000)
#define QEMU_OPTEE_PAGEABLE_LOAD_SIZE	0x00400000

#if (QEMU_OPTEE_PAGEABLE_LOAD_BASE + QEMU_OPTEE_PAGEABLE_LOAD_SIZE) > \
		(SEC_DRAM_BASE + SEC_DRAM_SIZE)
#error "OP-TEE pageable area is outside secure DRAM"
#endif
